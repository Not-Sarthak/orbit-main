...
const Services = () => {
  return (
    ...
    <div className="grid w-full max-w-screen-xl animate-fade-up bg-white border border-gray-200 p-8 rounded-2xl grid-cols-1 gap-5 px-5 md:grid-cols-3 custom-shadow">
  {/* Left */}
  ...
  <div className="relative col-span-1 rounded-xl bg-white md:col-span-2 bg-transparent">
    <div className="flex h-full items-center justify-center">
      <div className='grid grid-cols-2 md:gap-56 md:p-0 pt-16 pb-0 gap-28'>
        <div>Service 1</div>
        <div>Service 2</div>
        <div>Service 3</div>
        <div>Service 4</div>
