    ...
    <div>
      <h1 className="z-10 bg-gradient-to-br from-black via-stone-700 to-stone-500 bg-clip-text text-center font-display md:text-4xl text-2xl font-bold tracking-[-0.05em] text-transparent drop-shadow-sm [text-wrap:balance]">
        <div className="flex flex-col">
          <div>Services provided by AO's Web3 Oracle:</div>
        </div>
      </h1>
  ...
  <div className="relative col-span-1 rounded-xl bg-transparent md:col-span-2">
    <div className="flex h-full items-center justify-center">
      <div className='grid grid-cols-1 gap-4 pt-6 lg:pt-0 lg:gap-10'>
        <div className='flex items-center gap-2 lg:pb-0 pb-6'><img src={getData}/><div className='bg-gradient-to-br from-black via-stone-700 to-stone-500 bg-clip-text text-lg'>Get Data from <i className='pr-1'>any</i> HTTP URL</div></div>
        <div></div>
        <div></div>
        <div className='flex items-center gap-2'><img src={price}/><div className='bg-gradient-to-br from-black via-stone-700 to-stone-500 bg-clip-text text-lg'>Get Price Feeds</div></div>
      </div>
    </div>
      </div>
    </div>
